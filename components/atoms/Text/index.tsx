...
const VARIANTS = {
  h1_jumbo: 'font-georgia text-5xl md:text-8xl ',
  h1: 'font-georgia text-4xl md:text-6xl',
  h2: 'font-georgia text-3xl md:text-5xl',
  s1: 'font-inter font-bold text-lg md:text-2xl',
